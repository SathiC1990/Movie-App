...
/*const movies = [
  ...
  },
  {
    ...
    title: "Dangal",
    description:
      "The inspiring true story of a father who trains his daughters to become world-class wrestlers, defying all odds and societal norms.",
    movie_year: 2016,
    ...
    poster_url:
      "https://www.bollywoodhungama.com/wp-content/uploads/2016/03/Dangale.jpg",
    price: "100.00",
  },
  {
    id: 3,
    ...
    poster_url:
      "https://m.media-amazon.com/images/I/81hQX9dJBhL._AC_UF894,1000_QL80_.jpg",
    price: "120.00",
  },
  {
    id: 4,
    title: "Parasite",
    description:
      "A dark comedy thriller about a poor family who schemes to become employed by a wealthy family and infiltrate their household. Winner of the 2020 Academy Award for Best Picture.",
    movie_year: 2019,
    ...
    poster_url:
      "https://www.originalfilmart.com/cdn/shop/files/parasite_2019_french_original_film_art_5000x.jpg?v=1716935881",
    price: "150.00",
  },
  {
    id: 5,
...
function fetchMovies() {
  fetch(
    ...
    .then((data) => {
      movies = data; // Update the global movies array
